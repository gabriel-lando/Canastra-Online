...
export const ptBR: Translations = {
  ...
  roundEnd: {
    ...
    waitingForLeader: '⏳ Aguardando o líder iniciar a próxima rodada...',
    showDetails: '📊 Mostrar Detalhes',
    hideDetails: '▲ Ocultar Detalhes',
    melds: 'Combinações',
    wentOut: 'saiu sem cartas',
    goOutBonus: 'bônus de saída',
    gameWon: '🎉 Você Ganhou!',
  ...
  errors: {
    ...
    leaderOnlyNextRound: 'Apenas o líder pode iniciar a próxima rodada',
    notInRoundEnd: 'Esta ação só está disponível no fim de rodada',
